...
eQTL_noninf <- fread(paste0("sQTL/release6.4_2022-05-19_inf_No_pop_nfe.allpairs.chr",args[2],".awk.addedcolumns.txt"))
eQTL_inf <- fread(paste0("sQTL/release6.4_2022-05-19_inf_Yes_pop_nfe.allpairs.chr",args[2],".awk.addedcolumns.txt"))
...
write.table(result, file=paste0("sQTL/",args[1],"_chr",args[2],"_",args[4],"_sQTL_noninfe.tsv"), sep="\t", col.names = T, row.names = F, quote=F)
...
write.table(result, file=paste0("sQTL/",args[1],"_chr",args[2],"_",args[4],"_sQTL_infe.tsv"), sep="\t", col.names = T, row.names = F, quote=F)
