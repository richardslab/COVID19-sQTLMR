...
eQTL_WBC <- eQTL_WBC %>% filter(pval_nominal < 5e-8)
...
eQTL_Lung <- eQTL_Lung %>% filter(pval_nominal < 5e-8)
...
saveRDS(res, "A2_WBC_eQTL_ALL.rds")
...
saveRDS(res, "A2_Lung_eQTL_ALL.rds")
...
saveRDS(res, "B2_WBC_eQTL_ALL.rds")
...
saveRDS(res, "B2_Lung_eQTL_ALL.rds")
...
saveRDS(res, "C2_WBC_eQTL_ALL.rds")
...
saveRDS(res, "C2_Lung_eQTL_ALL.rds")
