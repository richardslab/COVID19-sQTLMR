...
for(i in seq(1, dim(map)[1])){
  ...
  exp <- fread(paste0("sQTL_Lung/",splice,".tsv"))
  ...
  write.table(result, file="A2.coloc.lung.tsv", append=T, sep="\t", col.names = F, row.names = F, quote=F)
}

result <- fread("A2.coloc.lung.tsv")

colnames(result) <- c("phenotype_id", "NSNP","PP.H0.abf", "PP.H1.abf", "PP.H2.abf", "PP.H3.abf", "PP.H4.abf")
write.table(result, file="A2.coloc.lung.tsv", append=F, sep="\t", col.names = T, row.names = F, quote=F)
...
for(i in seq(1, dim(map)[1])){
  ...
  write.table(result, file="B2.coloc.lung.tsv", append=T, sep="\t", col.names = F, row.names = F, quote=F)
}

result <- fread("B2.coloc.lung.tsv")

colnames(result) <- c("phenotype_id", "NSNP","PP.H0.abf", "PP.H1.abf", "PP.H2.abf", "PP.H3.abf", "PP.H4.abf")
write.table(result, file="B2.coloc.lung.tsv", append=F, sep="\t", col.names = T, row.names = F, quote=F)
...
for(i in seq(1, dim(map)[1])){
  ...
  write.table(result, file="C2.coloc.lung.tsv", append=T, sep="\t", col.names = F, row.names = F, quote=F)
}

result <- fread("C2.coloc.lung.tsv")

colnames(result) <- c("phenotype_id", "NSNP","PP.H0.abf", "PP.H1.abf", "PP.H2.abf", "PP.H3.abf", "PP.H4.abf")
write.table(result, file="C2.coloc.lung.tsv", append=F, sep="\t", col.names = T, row.names = F, quote=F)
