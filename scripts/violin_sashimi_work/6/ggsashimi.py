...
def define_options():
        ...
        parser.add_argument("--Label1", type=str, help="First label", dest="label1")
        parser.add_argument("--Label2", type=str, help="Second label", dest="label2")
        parser.add_argument("--Label3", type=str, help="Third label", dest="label3")
...
#       args.bam = "/nfs/no_backup/rg/epalumbo/projects/tg/work/8b/8b0ac8705f37fd772a06ab7db89f6b/2A_m4_n10_toGenome.bam"
        ...
        #print(args.Label2) #works to get inputs
